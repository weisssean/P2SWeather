...
/**
 * Created by TacoEater on 1/28/18 for project BoseWeather.
 */


public class BoseLocationHelper implements PermissionUtils.PermissionResultCallback{
    ...
    public BoseLocationHelper(Context context) {
